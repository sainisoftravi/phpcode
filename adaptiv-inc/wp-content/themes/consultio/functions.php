...
function consultio_scripts() {
	...
	wp_enqueue_style( 'font-flaticon-v8', get_template_directory_uri() . '/assets/css/flaticon-v8.css', array(), $theme->get( 'Version' ) );
	...
	wp_add_inline_style( 'consultio-theme', consultio_inline_styles() );
