...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout4 slick-boxshadow <?php if($settings['style'] == 'style2') { echo 'dots-square'; } ?> ct-slick-slider <?php echo esc_attr($settings['style'].' '.$settings['style_l2']); ?>">
