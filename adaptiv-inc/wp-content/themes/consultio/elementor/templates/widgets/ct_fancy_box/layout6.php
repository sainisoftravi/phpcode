...
?>
<div class="ct-fancy-box ct-fancy-box-layout6 <?php echo esc_attr($settings['ct_animate'].' '.$settings['style_l6']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
